...
class TabbedFlashCardsModel  {
    ...
    func setQuestion(pQuestion:String) {
        self.questions[self.currentQuestionIndex] = pQuestion
    }
    
    func setAnswer(pAnswer:String)  {
        self.answers[self.currentQuestionIndex] = pAnswer
    }
